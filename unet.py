...
class myUnet(object):
	...
	def train(self):
		...
		print('Fitting model...')
		model.fit(imgs_train, imgs_mask_train, batch_size=4, nb_epoch=10, verbose=1,validation_split=0.2, shuffle=True,class_weight= {0:1,1:20}, callbacks=[model_checkpoint])
